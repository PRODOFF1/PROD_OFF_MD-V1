...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/PRODOFF1/PROD_OFF_MD-V1';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://github.com/PRODOFF1/PROD_OFF_MD-V1' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'PROD OFF HACK',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
